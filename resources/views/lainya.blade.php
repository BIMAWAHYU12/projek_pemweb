    ...
    <div class="bg-gray-50 min-h-screen py-10" x-data="{ showModal: false, selected: null }">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-10">
                <h2 class="text-3xl font-bold text-gray-900">Informasi Lainya</h2>
                <p class="mt-2 text-gray-600">Temukan beragam informasi menarik lainnya yang relevan dengan mahasiswa — dari peluang beasiswa, pelatihan, hingga insight karier yang berguna!</p>
            </div>
            ...
            >
                ...
                @empty
                    <div class="col-span-full text-center text-gray-500 py-20">
                        <p class="text-lg font-medium">Belum ada informasi untuk saat ini.</p>
                    </div>
                @endforelse
            </div>
