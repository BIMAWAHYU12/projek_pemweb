...
<head>
    ...
    <title>Tempat Magang</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    <script src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js" defer></script>
</head>
<body>
<x-app-layout>
    <div class="bg-gray-100	 min-h-screen py-10" x-data="{ showModal: false, selected: null }">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <!-- Heading -->
            <div class="text-center mb-10">
                <h2 class="text-3xl font-bold text-gray-900">Daftar Tempat Magang</h2>
                <p class="mt-2 text-gray-600">Temukan tempat magang, perluas pengalaman, dan bangun koneksi yang bermanfaat untuk masa depanmu!</p>
            </div>
...
>
    ...
    @empty
        <div class="col-span-full text-center text-gray-500 py-20">
            <p class="text-lg font-medium">Belum ada informasi Tempat Magang untuk saat ini.</p>
        </div>
    @endforelse
</div>
