    ...
    <div class="bg-gray-50 min-h-screen py-10" x-data="{ showModal: false, selected: null }">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-10">
                <h2 class="text-3xl font-bold text-gray-900">Informasi Volunteer</h2>
                <p class="mt-2 text-gray-600">Gabung sebagai relawan, ambil peran positif dalam masyarakat, dan kembangkan empati serta pengalaman nyata yang berharga untuk masa depanmu!</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                @empty
                    <div class="col-span-full text-center text-gray-500 py-20">
                        <p class="text-lg font-medium">Belum ada informasi Volunteer untuk saat ini.</p>
                    </div>
                @endforelse
            </div>
